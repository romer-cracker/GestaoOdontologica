				...
				<div class="span6">
					<div class="widget-box">
						<div class="widget-title">
							...
							<h5>Cadastros de Consultas</h5>
						</div>
						<div class="widget-content nopadding" >
							<form action="<%=request.getContextPath()%>/ServletConsultaController" method="post" class="form-horizontal" id="formUser">
								<div class="control-group">
									<label class="control-label" for="id">ID :</label>
									<div class="controls">
										<input type="text" class="span11" id="id" name="id" readonly="readonly" value="${consulta.id}">
									</div>
								</div>
								<div class="control-group">
		 ...
		 $.ajax({	     
			 ...
			 $("#ulPaginacaoUserAjax > li").remove();
			  ...
			  for(var p = 0; p < json.length; p++){
			      $('#tabelaresultados > tbody').append('<tr> <td>'+json[p].id+'</td> <td> '+json[p].paciente+'</td> <td><button onclick="verEditar('+json[p].id+')" type="button" class="btn btn-info">Ver</button></td></tr>');
			  }
